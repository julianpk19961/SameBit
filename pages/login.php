...
<!-- Theme Toggle Button -->
<button class="theme-toggle light-mode" aria-label="Switch to dark mode" title="Toggle dark/light mode (Ctrl+Shift+T)">
  ...
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="moon-icon">
