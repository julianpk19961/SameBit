  ...
  <div class="container" id="form">
    ...
    <section class="row">
        <section class="col-md-12">
          ...
          <section class="row">
            <div class="col-md-4">
              <div id="stepsList" class="form_group">
    ...
    <section class="row"> 
       ...
       <div class="form-group col-md-4">
        <!-- Modal button -->
        <div class="row">
            <button id="modBtn" class="btn btn-primary mt-3" style="height: 30px;float:right;"  >Ver progreso</button>
        </div>
        <!-- Modal -->
        <div id="modal" class="modal">
            ...
            <div class="row">
            <button id="modCls" class="btn btn-primary mt-3" style="height: 30px;float:right;"  >Cerrar</button>
        </div>
        </div>
    ...
    <section class="row">
        ...
        <div class="form-group col-md-1">
          <p></p>
            <label class="text"><strong>Días Total</strong></label>
        </div>   
    </section>
    <p></p>
          ...
          <div id="modal" class="modal">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <h3>Modal Footer</h3>
                <button id="modCls" class="modal__button-link close-modal">
                          Close
                </button>
              </div>
            </div>
